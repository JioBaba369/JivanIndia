...
import { Globe, Mail, MapPin, Phone, Share2, Handshake, Building, Twitter, Linkedin, Facebook } from "lucide-react";
              ...
              <div className="lg:col-span-2">
                 <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex items-center gap-2 mt-4 md:mt-0">
                        {sponsor.socialMedia.twitter && <Button variant="outline" size="icon" asChild><Link href={sponsor.socialMedia.twitter} target="_blank"><Twitter/></Link></Button>}
