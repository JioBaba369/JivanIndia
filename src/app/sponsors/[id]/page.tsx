...
import { Globe, Mail, MapPin, Phone, Share2, Handshake, Twitter, Linkedin, Facebook, Loader2, Instagram } from "lucide-react";
              ...
              <div className="lg:col-span-2">
                 <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex items-center gap-2 mt-4 md:mt-0">
                        {sponsor.socialMedia.twitter && <Button variant="outline" size="icon" asChild><a href={formatUrl(sponsor.socialMedia.twitter)} target="_blank" rel="noopener noreferrer"><Twitter className="h-4 w-4"/></a></Button>}
