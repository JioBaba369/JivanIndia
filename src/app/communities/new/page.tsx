                  ...
                  <FormField
                      ...
                      render={({ field }) => (
                          <FormItem>
                              ...
                              <FormControl>
                                  <Textarea placeholder="A brief, one-sentence summary for listing pages." {...field} rows={2} maxLength={DESC_MAX_LENGTH} />
                              </FormControl>
                   ...
                   <FormField
                      ...
                      render={({ field }) => (
                          <FormItem>
                              ...
                              <FormControl>
                                  <Textarea placeholder="Provide a detailed description of your community's mission, activities, history, and who it's for." {...field} rows={5} maxLength={FULL_DESC_MAX_LENGTH} />
                              </FormControl>
                              <FormDescription className="flex justify-between">
