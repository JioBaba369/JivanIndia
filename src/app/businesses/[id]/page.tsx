...
import { Globe, Mail, MapPin, Phone, Share2, Star, Bookmark, BadgeCheck, Loader2, Edit, Twitter, Facebook, Linkedin, Instagram, Users } from "lucide-react";
            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-grow text-center md:text-left">
                 ...
                 <div className="mt-4 flex justify-center md:justify-start items-center gap-2">
                    {business.socialMedia?.twitter && <Button variant="outline" size="icon" asChild><Link href={formatUrl(business.socialMedia.twitter)} target="_blank"><Twitter className="h-4 w-4"/></Link></Button>}
                    {business.socialMedia?.instagram && <Button variant="outline" size="icon" asChild><Link href={formatUrl(business.socialMedia.instagram)} target="_blank"><Instagram className="h-4 w-4" /></Link></Button>}
                    {business.socialMedia?.linkedin && <Button variant="outline" size="icon" asChild><Link href={formatUrl(business.socialMedia.linkedin)} target="_blank"><Linkedin className="h-4 w-4"/></Link></Button>}
                    {business.socialMedia?.facebook && <Button variant="outline" size="icon" asChild><Link href={formatUrl(business.socialMedia.facebook)} target="_blank"><Facebook className="h-4 w-4"/></Link></Button>}
                    {business.socialMedia?.facebookGroup && <Button variant="outline" size="icon" asChild><Link href={formatUrl(business.socialMedia.facebookGroup)} target="_blank"><Users/></Link></Button>}
                </div>
            </div>
