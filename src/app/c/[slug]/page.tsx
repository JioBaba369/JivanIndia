...
import { Calendar, Globe, Mail, MapPin, Phone, Users, Share2, Bookmark, BadgeCheck, Twitter, Linkedin, Facebook, Edit, Loader2, BarChart2, Settings, Building, MoreVertical, Instagram } from "lucide-react";
                ...
                <div className="flex-grow text-center md:text-left">
                    <div className="flex justify-between items-start">
                     ...
                     <div className="mt-4 flex justify-center md:justify-start items-center gap-2">
                        {community.socialMedia?.twitter && <Button variant="outline" size="icon" asChild><Link href={community.socialMedia.twitter} target="_blank"><Twitter className="h-4 w-4"/></Link></Button>}
